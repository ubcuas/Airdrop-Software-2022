...
namespace sensor
{
    namespace gps
    {
        ...
        {
            double distance = GPSCoordinate::DistanceBetween(latitude, longitude,
        ...
        {
            double heading = GPSCoordinate::CourseTo(latitude, longitude, dest.latitude, dest.longitude);
            return heading;
        }
        ...
        {
            double heading = GPSCoordinate::CourseTo(src.GetLatitude(), src.GetLongitude(),
                                                dest.GetLatitude(), dest.GetLongitude());
            return heading;
        }
