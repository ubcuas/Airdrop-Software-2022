...
* 2. [Coding Standard](#CodingStandard)
	...
	* 2.6. [Macro Names](#MacroNames)
	* 2.7. [Function Comments](#FunctionComments)
	* 2.8. [Global Variables](#GlobalVariables)
...
###  2.6. <a name='MacroNames'></a>Macro Names
...
###  2.7. <a name='FunctionComments'></a>Function Comments
Declaration comments describe use of the function (when it is non-obvious); comments at the definition of a function describe operation.

###  2.8. <a name='GlobalVariables'></a>Global Variables
